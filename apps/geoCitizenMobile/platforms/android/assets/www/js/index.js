 ...
 */
/*
 * Called before the newReportPage is shown
 */
...
/*
 * Called when the observationDetailPage gets shown
 ...
 * Called before the listviewPage is shown
 */
$( document ).on("pagebeforeshow", '#processDetailPage', function(event, ui){
		
	// discussion Button
    $("#discussionBtn").on("click", function() {
...
/*
 * Called when the processDetailPage gets shown

$( document ).on("pageshow", '#processDetailPage', function(event, ui){
...
$( document ).on("pageshow", '#discussionPage', function(event, ui){
    ...
    $("#searchButton").on("click", function() {
		...
		//search discussions and open Listview
		//userMgr.gotoListViewPage();
		
		// -> TODO discussionMgr search discussions
    });
    ...
    $("#discussionTableBody").on('click','tr',function(e){
        ...
        // alert("DiscussionID = " + id + "     Type = " + messageclass); //TESTONLY
        
        if(messageclass == 'comment'){
        	userMgr.gotoDiscussionPage();
        	discussionMgr.loadReplys(id);
        }
